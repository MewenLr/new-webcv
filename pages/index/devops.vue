<template lang='pug'>
  .devops
    nuxt-link(to="/web-development?page=1" style="color: white") Web Dev
    //- nuxt-link(to="/web-development") Accueil
    //- o-background
    //- o-scroller(:page="1")
...
import dataset from '@/assets/data/datasets/devops.dataset'
